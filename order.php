    ...
    <article>
        ...
        while ($roww = mysqli_fetch_assoc($resultt)) {
            ?>
                    <div class="list-group-item list-group-item-action p-4 order d-flex">
                        <div class="col-9">
                        <p class="d-flex">&nbsp&nbsp&nbsp&nbsp&nbsp<img class="img-fluid img-brand d-block " src="assets/img/avatar.jpg" alt="avatar" /><span class="mx-2 mt-2"><?php echo $roww ['name']?></span></p>
                            <p>&nbsp&nbsp&nbsp&nbsp&nbsp<?php echo $roww ['content']?></p>
    ...
    <footer class="footer py-4">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-4 text-lg-start">Copyright &copy; Świat Motoryzacji 2022</div>
